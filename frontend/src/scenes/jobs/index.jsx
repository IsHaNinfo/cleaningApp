...
import { Box, Button, IconButton, Tooltip, useTheme, Select, MenuItem } from "@mui/material";
...
const Jobs = () => {
  ...
  const handleStatusChange = async (id, newStatus) => {
      try {
          const response = await axios.patch(environment.apiUrl + `/job/updateStatus/${id}`, { jobStatus: newStatus });
